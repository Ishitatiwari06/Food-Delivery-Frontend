...
export default function Card(props) {
  ...
  return (
    <div>
      <div className="mt-16 mb-32 bg-white rounded-lg shadow-lg w-72 h-[420px] flex flex-col">
        <img src={props.img} className="w-full h-48 object-cover rounded-t-lg" alt="..." />
